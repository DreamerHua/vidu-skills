...
Create a material element (subject) with 1–3 images, name and description; for use in character2video. Uploads each image via the same flow as `upload_image.py`, then POSTs to `/vidu/v1/material/elements`.
...
# 参考生视频 (2-7 images, Q2 only; script omits transition)
